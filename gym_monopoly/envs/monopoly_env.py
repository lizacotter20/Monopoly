...
from gym_monopoly.envs import custom_agent
...
class MonopolyEnv(gym.Env):
    ...
    def __init__(self, player_decision_agents, game_schema):
        ...
        if player_decision_agents['player_1'] == "background_agent_v1":
            ...
            self.player_decision_agents['player_1'] = Agent(**custom_agent.decision_agent_methods)
        ...
        if player_decision_agents['player_2'] == "background_agent_v1":
            ...
            self.player_decision_agents['player_2'] = Agent(**custom_agent.decision_agent_methods)
        ...
        if player_decision_agents['player_3'] == "background_agent_v1":
            ...
            self.player_decision_agents['player_3'] = Agent(**custom_agent.decision_agent_methods)
        ...
        if player_decision_agents['player_4'] == "background_agent_v1":
            ...
            self.player_decision_agents['player_4'] = Agent(**custom_agent.decision_agent_methods)
